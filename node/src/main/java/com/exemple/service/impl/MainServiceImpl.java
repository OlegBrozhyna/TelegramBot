...
import static com.exemple.entity.enums.UserState.WAIT_FOR_EMAIL_STATE;
import static com.exemple.service.enums.ServiceCommand.*;
...
public class MainServiceImpl implements MainService {
    ...
    private String processServiceCommand(AppUser appUser, String cmd) {
        if ((REGISTRATION.equals(cmd))) {
            ...
            return "Unknown team! To see a list of available commands, type /help";
        }
    }
